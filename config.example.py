...
TREATMENT_START = date(
    2026, 1, 15
)  # Intervention start (e.g. new medication, for causal analysis)
KNOWN_EVENT_DATE = date(2026, 1, 10)  # Known acute episode (e.g. ER visit, infection)
HEV_DIAGNOSIS_DATE = date(
    2026, 2, 1
)  # Secondary diagnosis date (leave as-is if not applicable)
...
NORM_RMSSD_P25 = (
    36  # Population 25th percentile (young adults IQR: 36-79 ms, Nunan 2010)
)
NORM_RMSSD_P75 = (
    72  # Population 75th percentile (young adults IQR: 36-79 ms, Nunan 2010)
)
HSCT_RMSSD_RANGE = (
    25,
    40,
